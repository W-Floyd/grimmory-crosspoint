...
export class AuthenticationSettingsComponent {
  ...
  availablePermissions = [
    ...
    {label: 'Access OverDrive/Libby', value: 'permissionAccessOverdrive', selected: false, translationKey: 'perms.accessOverdrive'},
    {label: "Manage Sharing for Any User's OverDrive Cards", value: 'permissionManageAllOverdriveShares', selected: false, translationKey: 'perms.manageAllOverdriveShares'},
    {label: "Manage Any User's OverDrive Cards", value: 'permissionManageAllOverdriveCards', selected: false, translationKey: 'perms.manageAllOverdriveCards'},
