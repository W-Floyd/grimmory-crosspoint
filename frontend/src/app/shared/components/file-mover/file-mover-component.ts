...
export class FileMoverComponent implements OnDestroy {
   ...
   * roots, and assuming the first roots any file on another one incorrectly. These fields are not
   * currently rendered, so nothing user-visible was wrong — but the values were.
   */
