    ...
    const payload = [
      {
        ...
        newValue: {
          ...
          overdrive: {
            // Preserve library keys and format preference, which are managed on the Settings → OverDrive page.
            ...this.appSettingsService.appSettings()?.metadataProviderSettings?.overdrive,
