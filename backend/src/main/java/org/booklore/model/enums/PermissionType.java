...
public enum PermissionType {
    ...
    ACCESS_OVERDRIVE("permissionAccessOverdrive"),
    MANAGE_ALL_OVERDRIVE_SHARES("permissionManageAllOverdriveShares"),
    MANAGE_ALL_OVERDRIVE_CARDS("permissionManageAllOverdriveCards"),
