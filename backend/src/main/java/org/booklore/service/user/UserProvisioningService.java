...
public class UserProvisioningService {
    ...
    public void provisionInitialUser(InitialUserRequest request) {
        ...
        perms.setPermissionAccessOverdrive(true);
        perms.setPermissionManageAllOverdriveShares(true);
        perms.setPermissionManageAllOverdriveCards(true);
    ...
    public void provisionInternalUser(UserCreateRequest request) {
        ...
        permissions.setPermissionAccessOverdrive(request.isPermissionAccessOverdrive());
        permissions.setPermissionManageAllOverdriveShares(request.isPermissionManageAllOverdriveShares());
        permissions.setPermissionManageAllOverdriveCards(request.isPermissionManageAllOverdriveCards());
        UserPermission.normalize(permissions);
    ...
    public BookLoreUserEntity provisionOidcUser(String username, String email, String name,
        ...
        if (defaultPermissions != null) {
            ...
            perms.setPermissionAccessOverdrive(defaultPermissions.contains("permissionAccessOverdrive"));
            perms.setPermissionManageAllOverdriveShares(defaultPermissions.contains("permissionManageAllOverdriveShares"));
            perms.setPermissionManageAllOverdriveCards(defaultPermissions.contains("permissionManageAllOverdriveCards"));
    ...
    public BookLoreUserEntity provisionRemoteUserFromHeaders(String name, String username, String email, String groups) {
        ...
        if (oidcAutoProvisionDetails != null && oidcAutoProvisionDetails.getDefaultPermissions() != null) {
            ...
            permissions.setPermissionAccessOverdrive(defaultPermissions.contains("permissionAccessOverdrive"));
            permissions.setPermissionManageAllOverdriveShares(defaultPermissions.contains("permissionManageAllOverdriveShares"));
            permissions.setPermissionManageAllOverdriveCards(defaultPermissions.contains("permissionManageAllOverdriveCards"));
            UserPermission.normalize(permissions);
