...
public class OidcGroupMappingService {
    ...
    private void applyPermissions(UserPermissionsEntity perms, Set<String> permissions, boolean isAdmin, boolean additive) {
        if (!additive) {
            ...
            perms.setPermissionAccessOverdrive(permissions.contains("permissionAccessOverdrive"));
            perms.setPermissionManageAllOverdriveShares(permissions.contains("permissionManageAllOverdriveShares"));
            perms.setPermissionManageAllOverdriveCards(permissions.contains("permissionManageAllOverdriveCards"));
            ...
            if (permissions.contains("permissionAccessOverdrive")) perms.setPermissionAccessOverdrive(true);
            if (permissions.contains("permissionManageAllOverdriveShares")) perms.setPermissionManageAllOverdriveShares(true);
            if (permissions.contains("permissionManageAllOverdriveCards")) perms.setPermissionManageAllOverdriveCards(true);
            UserPermission.normalize(perms);
